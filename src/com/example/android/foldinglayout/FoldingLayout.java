...
public class FoldingLayout extends ViewGroup {
    ...
    private class NumberOfFoldingLayoutChildrenException extends RuntimeException {
        /**
         * Generated serial ID. This needs to change if this class changes.
         */
      private static final long serialVersionUID = -2304974623201779862L;
    ...
    private void prepareFold(Orientation orientation, float anchorFactor, int numberOfFolds) {
        ...
        // XXX_jwir3: Removed because otherwise a dependency is introduced
        //            between FoldingLayout -> FoldingLayoutActivity, which
        //            shouldn't exist.
    ...
    */
    private void calculateMatrices() {
        ...
        float depth = mIsHorizontal ?
                (float)Math.sqrt(mFoldDrawWidth * mFoldDrawWidth -
                        translatedDistanceFoldSquared) :
                (float)Math.sqrt(mFoldDrawHeight * mFoldDrawHeight -
                        translatedDistanceFoldSquared);
